...
namespace MovieShop.Infrastructure.Migrations
{
    ...
    [Migration("20200510194142_addRatingforMovieTable")]
    partial class addRatingforMovieTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieShop.Core.Entites.Favorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MovieShop.Core.Entites.Purchase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MovieShop.Core.Entites.Review", b =>
                {
                    b.Property<int>("MovieId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieShop.Core.Entites.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MovieShop.Core.Entites.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MovieShop.Core.Entites.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MovieShop.Core.Entites.Favorite", b =>
                {
                    ...
                    b.HasOne("MovieShop.Core.Entites.User", "User")
                        .WithMany("Favorites")
            ...
            modelBuilder.Entity("MovieShop.Core.Entites.Purchase", b =>
                {
                    ...
                    b.HasOne("MovieShop.Core.Entites.User", "Customer")
                        .WithMany("Purchases")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MovieShop.Core.Entites.UserRole", b =>
                {
                    b.HasOne("MovieShop.Core.Entites.Role", "Role")
                        .WithMany("UserRoles")
